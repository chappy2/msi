...
%  \Large\chapapp~\thechapter   % Große Schrift
 \vspace{0.2cm}               % Abstand zum Titel des Kapitels
%}

% Abstände für die Überschriften setzen
\renewcommand{\chapterheadstartvskip}{\vspace*{1.6cm}}
\renewcommand{\chapterheadendvskip}{\vspace*{1.1cm}}

\RedeclareSectionCommand[
  beforeskip=-1.8\baselineskip,
  afterskip=0.20\baselineskip]{section}
